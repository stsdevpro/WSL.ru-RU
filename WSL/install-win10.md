...
- **[Упрощенная установка](#simplified-installation-for-windows-insiders)** *(предварительный выпуск)* : `wsl --install`.
...
- **[Установка вручную](#manual-installation-steps)** : выполните приведенные ниже шаги.
...
## <a name="simplified-installation-for-windows-insiders"></a>Упрощенная установка для участников программы предварительной оценки Windows
...
- присоединиться к [Программе предварительной оценки Windows](https://insider.windows.com/getting-started);
...
## <a name="manual-installation-steps"></a>Шаги по установке вручную
